...
public class VehiclesController : Controller
{
    ...
    public async Task<IActionResult> Edit(int id)
    {
        ...
        var transmissionsTypes = await _context.TransmissionTypes.ToListAsync();
    ...
    public async Task<IActionResult> Edit(int id, VehicleEditViewModel vehicle)
    {
        ...
        var selectedTransmission = await _context.TransmissionTypes.FindAsync(vehicle.TransmissionsType);
